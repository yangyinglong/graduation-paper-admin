<template>
	<div class="register-main">
		<el-form label-position='left' :model="registerData" status-icon :rules="rules" ref="registerData" label-width="110px" class="demo-ruleForm">
			<br><br>
            ...
            <el-form-item label="邮箱：" prop="eMail">
            	<el-input v-model="registerData.eMail" placeholder="消息通知"></el-input>
            </el-form-item>
